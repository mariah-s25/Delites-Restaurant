...
$lastyears=date("Y-m-d",strtotime("-2 years"));
mysqli_query($mysqli,"DELETE FROM message WHERE date<'".$lastyears."'")or die(mysqli_error($mysqli));  
...
<body style="margin-left:25%; width:75%">          
    ...
    <table>
    	...
    	<tbody>
    		<?php
    			$query=mysqli_query($mysqli,"select * from message")or die(mysqli_error($mysqli));
