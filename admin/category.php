...
<body style="margin-left:25%; width:75%">          
    ...
    <table>
    	...
    	<tbody>
    		...
    		<tr>
    			...
    			<td><a href="menu_items.php?ctid=<?php echo $catid; ?>"><?php echo $catname; ?></a></td>
    			<td><img src="../img/<?php echo $catpic; ?>" height="60px" width="60px"></td>
    			<td style="width:50px;"><a href="category_delete.php?cgidd=<?php echo $catid;?>">Delete</a></td>
    			<td style="width:50px;"><a href="category_update.php?cgidu=<?php echo $catid;?>">Update</a></td>
    		</tr>
    	<?php } ?>
    </tbody>
    </table>
    ...
    <section>
    <div class="tablecontainer">
    <form id="form-submit" action="category_add.php" method="post">
    <table>
        <thead><tr>
        <th>Name</th>
        <th>Picture</th>
